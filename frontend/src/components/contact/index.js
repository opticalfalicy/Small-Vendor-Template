      ...
      <div className="contact-page main-item">
        ...
        <div className="inner">
          ...
          <div className="hours-div">
            <ul className="days">
              <li>Sunday: 11AM–9:30PM</li>
              <li>Monday: 10:25AM–9:25PM</li>
              <li>Tuesday: 10:25AM–9:25PM</li>
              <li>Wednesday: 10:25AM–9:25PM</li>
              <li>Thursday: 10:25AM–9:25PM</li>
              <li>Friday: 10:25AM–9:25PM</li>
